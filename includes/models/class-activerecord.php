...
use \WSAL\MainWPExtension\Helpers\DataHelper as DataHelper;
...
abstract class ActiveRecord {
	 ...
	 * Data connector
	 *
	 * @var \WSAL\MainWPExtension\Connector\ConnectorFactory
	 */
	protected $connector;
	...
	protected function getConnector() {
		...
		if ( $this->useDefaultAdapter ) {
			$this->connector = \WSAL\MainWPExtension\Connector\ConnectorFactory::GetDefaultConnector();
		} else {
			$this->connector = \WSAL\MainWPExtension\Connector\ConnectorFactory::GetConnector();
		}
		return $this->connector;
	}
	 ...
	 *
	 * @see \WSAL\MainWPExtension\Connector\ConnectorInterface::getAdapter()
	 */
			...
			if ( isset( $copy->$key ) ) {
				switch ( true ) {
					...
					case is_object( $copy->$key ):
						$json_decoded_val = DataHelper::JsonDecode( $val );
	 ...
	 *
	 * @see \WSAL\MainWPExtension\Adapters\MySQL\ActiveRecord::Delete()
	 ...
	 * @see \WSAL\MainWPExtension\Adapters\MySQL\ActiveRecord::Count()
	 * @return int count
	 */
	 ...
	 *
	 * @see \WSAL\MainWPExtension\Adapters\MySQL\ActiveRecord::IsInstalled()
	 * @return bool
	 */
	 ...
	 *
	 * @see \WSAL\MainWPExtension\Adapters\MySQL\ActiveRecord::Install()
	 */
	 ...
	 *
	 * @see \WSAL\MainWPExtension\Adapters\MySQL\ActiveRecord::GetReporting()
	 ...
	 *
	 * @see \WSAL\MainWPExtension\Models\ActiveRecord::LoadData()
