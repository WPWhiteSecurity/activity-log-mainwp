	...
	$activity_log->alerts->RegisterGroup(
		array(
			...
			__( 'Content & Comments', 'mwp-al-ext' ) => array(
				__( 'Content', 'mwp-al-ext' ) => array(
					array( 2000, WSAL_INFORMATIONAL, __( 'User created a new post and saved it as draft', 'mwp-al-ext' ), __( 'Created the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'created' ),
					array( 2001, WSAL_LOW, __( 'User published a post', 'mwp-al-ext' ), __( 'Published the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'published' ),
					array( 2002, WSAL_LOW, __( 'User modified a post', 'mwp-al-ext' ), __( 'Modified the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2008, WSAL_MEDIUM, __( 'User permanently deleted a post from the trash', 'mwp-al-ext' ), __( 'Permanently deleted the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% ', 'mwp-al-ext' ), 'post', 'deleted' ),
					array( 2012, WSAL_MEDIUM, __( 'User moved a post to the trash', 'mwp-al-ext' ), __( 'Moved the post %PostTitle% to trash %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% ', 'mwp-al-ext' ), 'post', 'deleted' ),
					array( 2014, WSAL_LOW, __( 'User restored a post from trash', 'mwp-al-ext' ), __( 'Restored the post %PostTitle% from trash %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'restored' ),
					...
					array( 2019, WSAL_INFORMATIONAL, __( 'User changed post author', 'mwp-al-ext' ), __( 'Changed the author of the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% Previous author: %OldAuthor% %LineBreak% New author: %NewAuthor% %LineBreak% %EditorLinkPost%.', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2021, WSAL_MEDIUM, __( 'User changed post status', 'mwp-al-ext' ), __( 'Changed the status of the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Previous status: %OldStatus% %LineBreak% New status: %NewStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2025, WSAL_LOW, __( 'User changed the visibility of a post', 'mwp-al-ext' ), __( 'Changed the visibility of the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% Previous visibility status: %OldVisibility% %LineBreak% New visibility status: %NewVisibility% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2027, WSAL_INFORMATIONAL, __( 'User changed the date of a post', 'mwp-al-ext' ), __( 'Changed the date of the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% Previous date: %OldDate% %LineBreak% New date: %NewDate% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2047, WSAL_LOW, __( 'User changed the parent of a page', 'mwp-al-ext' ), __( 'Changed the parent of the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% Previous parent: %OldParentName% %LineBreak% New parent: %NewParentName% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2048, WSAL_LOW, __( 'User changed the template of a page', 'mwp-al-ext' ), __( 'Changed the template of the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% Previous template: %OldTemplate% %LineBreak% New template: %NewTemplate% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2049, WSAL_INFORMATIONAL, __( 'User set a post as sticky', 'mwp-al-ext' ), __( 'Set the post %PostTitle% as sticky %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2050, WSAL_INFORMATIONAL, __( 'User removed post from sticky', 'mwp-al-ext' ), __( 'Removed the post %PostTitle% from sticky %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2065, WSAL_LOW, __( 'User modified the content of a post', 'mwp-al-ext' ), __( 'Modified the content of the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %RevisionLink% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2073, WSAL_INFORMATIONAL, __( 'User submitted a post for review', 'mwp-al-ext' ), __( 'Submitted the post %PostTitle% for review %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2074, WSAL_LOW, __( 'User scheduled a post', 'mwp-al-ext' ), __( 'Scheduled the post %PostTitle% to be published on %PublishingDate% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2086, WSAL_INFORMATIONAL, __( 'User changed title of a post', 'mwp-al-ext' ), __( 'Changed the title of the post %OldTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% New title: %NewTitle% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'modified' ),
					array( 2100, WSAL_INFORMATIONAL, __( 'User opened a post in the editor', 'mwp-al-ext' ), __( 'Opened the post %PostTitle% in the editor %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'opened' ),
					...
					array( 2111, WSAL_LOW, __( 'User enabled/disabled comments in a post', 'mwp-al-ext' ), __( 'The comments in the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'enabled' ),
					array( 2112, WSAL_LOW, __( 'User enabled/disabled trackbacks and pingbacks in a post', 'mwp-al-ext' ), __( 'Pingbacks and Trackbacks in the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'post', 'enabled' ),
				),
			 ...
			 __( 'Custom Fields', 'mwp-al-ext' ) => array(
				 ...
				 array( 2062, WSAL_LOW, __( 'User updated a custom field name for a post', 'mwp-al-ext' ), __( 'Previous custom field name: %MetaKeyOld% %LineBreak% New custom field name: %MetaKeyNew% %LineBreak% Post: %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% %EditorLinkPost%', 'mwp-al-ext' ), 'custom-field', 'renamed' ),
			 ),
		...
		*/
		__( 'Comments', 'mwp-al-ext' ) => array(
			...
			array( 2098, WSAL_LOW, __( 'User permanently deleted a comment', 'mwp-al-ext' ), __( 'Permanently deleted the comment posted by %Author% on the post %PostTitle% %LineBreak% Post ID: %PostID% %LineBreak% Post type: %PostType% %LineBreak% Post status: %PostStatus% %LineBreak% Comment ID: %CommentID% ', 'mwp-al-ext' ), 'comment', 'deleted' ),
			...
			*/
			__( 'Menus', 'mwp-al-ext' ) => array(
				...
				array( 2084, WSAL_LOW, __( 'User changed name of a menu', 'mwp-al-ext' ), __( 'Previous name: %OldMenuName% %LineBreak% New name: %MenuName%', 'mwp-al-ext' ), 'menu', 'renamed' ),
