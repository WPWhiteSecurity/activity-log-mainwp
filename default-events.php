		...
		array(
			...
			__( 'Users Profiles & Activity', 'wp-security-audit-log' ) => array(
				...
				__( 'Other User Activity', 'wp-security-audit-log' ) => array(
					...
					array( 2010, E_NOTICE, __( 'User uploaded file from Uploads directory', 'wp-security-audit-log' ), __( 'Uploaded the file %1$FileName% in %2$FilePath%.', 'wp-security-audit-log' ) ),
					array( 2011, E_WARNING, __( 'User deleted file from Uploads directory', 'wp-security-audit-log' ), __( 'Deleted the file %1$FileName% from %2$FilePath%.', 'wp-security-audit-log' ) ),
				),
			...
			__( 'Third Party Plugins', 'wp-security-audit-log' ) => array(
				...
				__( 'WooCommerce', 'wp-security-audit-log' ) => array(
					...
					array( 9023, E_WARNING, __( 'User added the Downloadable File to a product', 'wp-security-audit-log' ), __( 'Added the Downloadable File %1$FileName% with File URL %2$FileUrl% to the product %ProductTitle%. View the product: %3$EditorLinkProduct%.', 'wp-security-audit-log' ) ),
					array( 9024, E_WARNING, __( 'User Removed the Downloadable File from a product', 'wp-security-audit-log' ), __( 'Removed the Downloadable File %1$FileName% with File URL %2$FileUrl% from the product %ProductTitle%. View the product: %3$EditorLinkProduct%.', 'wp-security-audit-log' ) ),
					...
					array( 9026, E_WARNING, __( 'User changed the URL of the Downloadable File in a product', 'wp-security-audit-log' ), __( 'Changed the URL of the Downloadable File %1$FileName% from %OldUrl% to %NewUrl% in product %ProductTitle%. View the product: %2$EditorLinkProduct%.', 'wp-security-audit-log' ) ),
				...
				__( 'Yoast SEO', 'wp-security-audit-log' ) => array(
					...
					array( 8807, E_NOTICE, __( 'User changed the focus keyword of a SEO post', 'wp-security-audit-log' ), __( 'Changed the focus keyword of the %PostStatus% %PostType% titled %PostTitle% from %1$old_keywords% to %new_keywords%. %2$EditorLinkPost%.', 'wp-security-audit-log' ) ),
