		...
		array(
			...
			__( 'WordPress Install', 'mwp-al-ext' ) => array(
				...
				__( 'System', 'mwp-al-ext' ) => array(
					...
					array( 6031, E_CRITICAL, __( 'File not scanned because it is bigger than the maximum file size limit', 'mwp-al-ext' ), __( 'The file %FileLocation% was not scanned because it is bigger than the maximum file size limit. If you want to include these files in the scan increase the file size limit from the %FileSettings%.', 'mwp-al-ext' ) ),
					array( 6032, E_CRITICAL, __( 'File integrity scan stopped due to the limit of 1 million files', 'mwp-al-ext' ), __( 'The file changes scanning engine has reached the limit of 1 million files and stopped the scan. Please %ContactSupport% for more information.', 'mwp-al-ext' ) ),
					array( 6033, E_NOTICE, __( 'File integrity scan started/stopped', 'mwp-al-ext' ), __( 'The file integrity scanner has %ScanStatus%.', 'mwp-al-ext' ) ),
			...
			__( 'Third Party Plugins', 'mwp-al-ext' ) => array(
				...
				__( 'WooCommerce Products', 'mwp-al-ext' ) => array(
					...
					array( 9003, E_NOTICE, __( 'User changed the category of a product', 'mwp-al-ext' ), __( 'Changed the category of the %ProductStatus% product %ProductTitle% from %OldCategories% to %NewCategories%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9004, E_NOTICE, __( 'User modified the short description of a product', 'mwp-al-ext' ), __( 'Modified the short description of the %ProductStatus% product %ProductTitle%.%ChangeText% View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9005, E_NOTICE, __( 'User modified the text of a product', 'mwp-al-ext' ), __( 'Modified the text of the %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9006, E_NOTICE, __( 'User changed the URL of a product', 'mwp-al-ext' ), __( 'Changed the URL of the %ProductStatus% product %ProductTitle%%ReportText%.%ChangeText% View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9008, E_NOTICE, __( 'User changed the date of a product', 'mwp-al-ext' ), __( 'Changed the date of the %ProductStatus% product %ProductTitle% from %OldDate% to %NewDate%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9009, E_NOTICE, __( 'User changed the visibility of a product', 'mwp-al-ext' ), __( 'Changed the visibility of the %ProductStatus% product %ProductTitle% from %OldVisibility% to %NewVisibility%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9010, E_NOTICE, __( 'User modified the product', 'mwp-al-ext' ), __( 'Modified the %ProductStatus% product %ProductTitle%. Product URL is %ProductUrl%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					...
					array( 9012, E_WARNING, __( 'User moved a product to trash', 'mwp-al-ext' ), __( 'Moved the %ProductStatus% product %ProductTitle% to trash. Product URL was %ProductUrl%.', 'mwp-al-ext' ) ),
					...
					array( 9016, E_WARNING, __( 'User changed type of a price', 'mwp-al-ext' ), __( 'Changed the %PriceType% of the %ProductStatus% product %ProductTitle% from %OldPrice% to %NewPrice%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9017, E_WARNING, __( 'User changed the SKU of a product', 'mwp-al-ext' ), __( 'Changed the SKU of the %ProductStatus% product %ProductTitle% from %OldSku% to %NewSku%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9018, E_CRITICAL, __( 'User changed the stock status of a product', 'mwp-al-ext' ), __( 'Changed the stock status of the %ProductStatus% product %ProductTitle% from %OldStatus% to %NewStatus%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					...
					array( 9020, E_WARNING, __( 'User set a product type', 'mwp-al-ext' ), __( 'Changed the type of the %ProductStatus% product %ProductTitle% from %OldType% to %NewType%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9021, E_WARNING, __( 'User changed the weight of a product', 'mwp-al-ext' ), __( 'Changed the weight of the %ProductStatus% product %ProductTitle% from %OldWeight% to %NewWeight%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9022, E_WARNING, __( 'User changed the dimensions of a product', 'mwp-al-ext' ), __( 'Changed the %DimensionType% dimensions of the %ProductStatus% product %ProductTitle% from %OldDimension% to %NewDimension%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9023, E_WARNING, __( 'User added the Downloadable File to a product', 'mwp-al-ext' ), __( 'Added the Downloadable File %FileName% with File URL %FileUrl% to the %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9024, E_WARNING, __( 'User Removed the Downloadable File from a product', 'mwp-al-ext' ), __( 'Removed the Downloadable File %FileName% with File URL %FileUrl% from the %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9025, E_WARNING, __( 'User changed the name of a Downloadable File in a product', 'mwp-al-ext' ), __( 'Changed the name of a Downloadable File from %OldName% to %NewName% in %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9026, E_WARNING, __( 'User changed the URL of the Downloadable File in a product', 'mwp-al-ext' ), __( 'Changed the URL of the Downloadable File %FileName% from %OldUrl% to %NewUrl% in %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9042, E_NOTICE, __( 'User changed the catalog visibility of a product', 'mwp-al-ext' ), __( 'Changed the catalog visibility of the %ProductStatus% product %ProductTitle% from %OldVisibility% to %NewVisibility%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9043, E_NOTICE, __( 'User changed the setting Featured Product of a product', 'mwp-al-ext' ), __( '%Status% the setting Featured Product in the %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9044, E_WARNING, __( 'User changed the Allow Backorders setting of a product', 'mwp-al-ext' ), __( 'Changed the Allow Backorders setting of the %ProductStatus% product %ProductTitle% from %OldStatus% to %NewStatus%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9045, E_NOTICE, __( 'User added/removed products to upsell of a product', 'mwp-al-ext' ), __( '%Status% the product %UpsellTitle% to Upsells in the %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9046, E_NOTICE, __( 'User added/removed products to cross-sells of a product', 'mwp-al-ext' ), __( '%Status% the product %CrossSellTitle% to Cross-sells in the %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9047, E_NOTICE, __( 'Added a new attribute of a product', 'mwp-al-ext' ), __( 'Added a new attribute called %AttributeName% with value %AttributeValue% in the %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9048, E_NOTICE, __( 'Modified the value of an attribute of a product', 'mwp-al-ext' ), __( 'Modified the value of the attribute %AttributeName% from %OldValue% to %NewValue% in the %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9049, E_NOTICE, __( 'Changed the name of an attribute of a product', 'mwp-al-ext' ), __( 'Changed the attribute\'s name from %OldValue% to %NewValue% in the %ProductStatus% product %ProductTitle%. URL is: %ProductUrl%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9050, E_NOTICE, __( 'Deleted an attribute of a product', 'mwp-al-ext' ), __( 'Deleted the attribute %AttributeName% with value %AttributeValue% from %ProductStatus% product %ProductTitle%. URL is: %ProductUrl%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
					array( 9051, E_WARNING, __( 'Set the attribute visibility of a product', 'mwp-al-ext' ), __( 'Set the attribute %AttributeName% as %AttributeVisiblilty% on product page in %ProductStatus% product %ProductTitle%. View the product: %EditorLinkProduct%.', 'mwp-al-ext' ) ),
				),
				...
				__( 'WooCommerce', 'mwp-al-ext' ) => array(
					...
					array( 9034, E_CRITICAL, __( 'User Enabled/Disabled cash on delivery', 'mwp-al-ext' ), __( '%Status% the option Cash on Delivery in WooCommerce.', 'mwp-al-ext' ) ),
					array( 9074, E_CRITICAL, __( 'User enabled a payment gateway', 'mwp-al-ext' ), __( 'Enabled the payment gateway %GatewayName%.', 'mwp-al-ext' ) ),
					array( 9075, E_CRITICAL, __( 'User disabled a payment gateway', 'mwp-al-ext' ), __( 'Disabled the payment gateway %GatewayName%.', 'mwp-al-ext' ) ),
					array( 9076, E_CRITICAL, __( 'User modified a payment gateway', 'mwp-al-ext' ), __( 'Modified the payment gateway %GatewayName%.', 'mwp-al-ext' ) ),
					...
					array( 9052, E_WARNING, __( 'User deleted a product category', 'mwp-al-ext' ), __( 'Deleted the product category called %CategoryName% in WooCommerce. Product category slug was %CategorySlug%.', 'mwp-al-ext' ) ),
					array( 9053, E_WARNING, __( 'User changed the slug of a product category', 'mwp-al-ext' ), __( 'Changed the Slug of the product category %CategoryName% in WooCommerce from %OldSlug% to %NewSlug%.', 'mwp-al-ext' ) ),
					array( 9054, E_NOTICE, __( 'User changed the parent category of a product category', 'mwp-al-ext' ), __( 'Changed the Parent Category of the product category %CategoryName% in WooCommerce from %OldParentCat% to %NewParentCat%.', 'mwp-al-ext' ) ),
					array( 9055, E_NOTICE, __( 'User changed the display type of a product category', 'mwp-al-ext' ), __( 'Changed the Display Type of the product category %CategoryName% in WooCommerce from %OldDisplayType% to %NewDisplayType%.', 'mwp-al-ext' ) ),
					array( 9056, E_NOTICE, __( 'User changed the name of a product category', 'mwp-al-ext' ), __( 'Changed the name of the product category %CategoryName% in WooCommerce from %OldName% to %NewName%.', 'mwp-al-ext' ) ),
					array( 9057, E_NOTICE, __( 'User created a new attribute', 'mwp-al-ext' ), __( 'Created a new Attribute called %AttributeName% with slug %AttributeSlug% in WooCommerce.', 'mwp-al-ext' ) ),
					array( 9058, E_WARNING, __( 'User deleted an attribute', 'mwp-al-ext' ), __( 'Deleted the Attribute called %AttributeName% with Slug %AttributeSlug% from WooCommerce.', 'mwp-al-ext' ) ),
					array( 9059, E_WARNING, __( 'User changed the slug of an attribute', 'mwp-al-ext' ), __( 'Changed the Slug of the Attribute %AttributeName% in WooCommerce from %OldSlug% to %NewSlug%.', 'mwp-al-ext' ) ),
					array( 9060, E_WARNING, __( 'User changed the name of an attribute', 'mwp-al-ext' ), __( 'Changed the Name of the Attribute %AttributeName% in WooCommerce from %OldName% to %NewName%.', 'mwp-al-ext' ) ),
					array( 9061, E_WARNING, __( 'User changed the default sort order of an attribute', 'mwp-al-ext' ), __( 'Changed the Default Sort Order of the Attribute %AttributeName% in WooCommerce from %OldSortOrder% to %NewSortOrder%.', 'mwp-al-ext' ) ),
					array( 9062, E_WARNING, __( 'User enabled/disabled the option Enable Archives of an attribute', 'mwp-al-ext' ), __( '%ArchivesStatus% the option Enable Archives in the Attribute %AttributeName% in WooCommerce.', 'mwp-al-ext' ) ),
					array( 9063, E_NOTICE, __( 'User published a new coupon', 'mwp-al-ext' ), __( 'Published a new coupon called %CouponName% in WooCommerce.', 'mwp-al-ext' ) ),
					array( 9064, E_WARNING, __( 'User changed the discount type of a coupon', 'mwp-al-ext' ), __( 'Changed the Discount Type of the %CouponStatus% WooCommerce coupon %CouponName% from %OldDiscountType% to %NewDiscountType%.', 'mwp-al-ext' ) ),
					array( 9065, E_WARNING, __( 'User changed the coupon amount of a coupon', 'mwp-al-ext' ), __( 'Changed the Coupon Amount of the %CouponStatus% WooCommerce coupon %CouponName% from %OldAmount% to %NewAmount%.', 'mwp-al-ext' ) ),
					array( 9066, E_WARNING, __( 'User changed the coupon expire date of a coupon', 'mwp-al-ext' ), __( 'Changed the Coupon Expire Date of the %CouponStatus% WooCommerce coupon %CouponName% from %OldDate% to %NewDate%.', 'mwp-al-ext' ) ),
					array( 9067, E_WARNING, __( 'User changed the usage restriction settings of a coupon', 'mwp-al-ext' ), __( 'Changed the Usage Restriction settings of the %CouponStatus% WooCommerce coupon %CouponName%.', 'mwp-al-ext' ) ),
					array( 9068, E_WARNING, __( 'User changed the usage limits settings of a coupon', 'mwp-al-ext' ), __( 'Changed the Usage Limits settings of the %CouponStatus% WooCommerce coupon %CouponName%.', 'mwp-al-ext' ) ),
					array( 9069, E_NOTICE, __( 'User changed the description of a coupon', 'mwp-al-ext' ), __( 'Changed the Description of the %CouponStatus% WooCommerce coupon %CouponName%.', 'mwp-al-ext' ) ),
					array( 9070, E_WARNING, __( 'User changed the status of a coupon', 'mwp-al-ext' ), __( 'Changed the Status of the WooCommerce coupon %CouponName% from %OldStatus% to %NewStatus%.', 'mwp-al-ext' ) ),
					array( 9071, E_WARNING, __( 'User renamed a WooCommerce coupon', 'mwp-al-ext' ), __( 'Renamed the WooCommerce coupon %OldName% to %NewName%.', 'mwp-al-ext' ) ),
					array( 9035, E_NOTICE, __( 'A WooCommerce order has been placed', 'mwp-al-ext' ), __( 'A WooCommerce order %OrderTitle% has just been placed.', 'mwp-al-ext' ) ),
					array( 9036, E_NOTICE, __( 'WooCommerce order status changed', 'mwp-al-ext' ), __( 'Marked the WooCommerce order %OrderTitle% as %OrderStatus%', 'mwp-al-ext' ) ),
					array( 9037, E_WARNING, __( 'User moved a WooCommerce order to trash', 'mwp-al-ext' ), __( 'Moved the WooCommerce order %OrderTitle% to trash.', 'mwp-al-ext' ) ),
					array( 9038, E_WARNING, __( 'User moved a WooCommerce order out of trash', 'mwp-al-ext' ), __( 'Moved the WooCommerce order %OrderTitle% out of trash.', 'mwp-al-ext' ) ),
